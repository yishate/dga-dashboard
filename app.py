...
with tab2:
    ...
    if total_5 > 0:
        ...
        # FIXED: D2 drops from [0, 1.5] down to the junction at [0, -3.29]
        d2X = [0, 6, 30.5, 23.5, 0]
        ...
        # FIXED: T2 now correctly anchors to the bottom junction at [0, -3.29]
        t2X = [0, 0, -23.5, -9.91]
        t2Y = [-3.29, -32.4, -32.4, 2.89]
        
        # FIXED: T1 links the upper junction [0, 1.5] to the lower junction [0, -3.29]
        t1X = [0, 0, -9.91, -23.5, -38, -9.7]
        t1Y = [1.5, -3.29, 2.89, -32.4, 12.4, 5.8]
