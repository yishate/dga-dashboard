...
with tab1:
    ...
    with col_chart:
        if (ch4 + c2h4 + c2h2) > 0:
            ...
            # NOTE: These are currently placeholder/T1 visual coordinates. 
            # The calculation logic above works perfectly, but you will eventually need to 
            # extract the visual Triangle 3 coordinates to perfect this drawing!
...
with tab2:
    ...
    if total_5 > 0:
        ...
        # ---------------------------------------------------------
        # PERFECTED PENTAGON 3 BOUNDARIES
        # ---------------------------------------------------------
        ...
        with col_pent_chart:
            ...
            # Label positions updated so they sit completely outside the pentagon shape
            label_positions = ['top center', 'top left', 'bottom left', 'bottom right', 'top right', 'top center']
            ...
            # scaleanchor="x" and scaleratio=1 lock the grid into a perfect square aspect ratio
